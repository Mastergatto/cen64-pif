...
#   Makefile for *NIX.
#
#   PIFSIM: PIF Interface SIMulator.
...
COMMON_CFLAGS = $(WARNINGS) $(PIF_FLAGS) -std=c99 -march=native -I. -I../include
COMMON_CXXFLAGS = $(WARNINGS) $(PIF_FLAGS) -std=c++0x -march=native -I. -I../include
